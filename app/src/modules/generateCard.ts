...
let path:string, itemName:string, nameTrunc:string = '';
let cardOpener:string, cardCloser:string;
 ...
 */
function generateResultsCard(item:SearchResultItem, posterPath: string){
 ...
 */
function generateDetailsCard(item:SearchResultItem){
